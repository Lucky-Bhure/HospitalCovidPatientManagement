...
<head>
<meta charset="UTF-8">
<title>Hospital Covid19 Patient Management</title>
...
<body>
	...
	<main>
		<div style="text-align:center; margin: 30px 0px 0px 0px; ">
			<h3 style="color: red;">Covid19 Report</h3>
		</div>
		<div>
			<table class="table" style=" text-align: center; color: white; margin: 15px 0px 303px 0px;">
  				<thead>
   					<tr>
